...
/// provided options.
///
/// - Note: This does nothing other than for the diff-based equality assertion.
/// The remaining assertions do not have diffs or output that would be affected
/// by the options. The options code path is validated for all assertions as
...
)
{
    ...
    switch kind
    {
        case .equal:
            ...
            body1 =
            {
                XCTKAssertEqual(1, 2, options: options1)
            }
            
            body2 =
            {
                XCTKAssertEqual(1, 2, options: options2)
            }
...
/// diff-based equality assertion. The remaining assertions do not have diffs
/// or decomposed expressions to output that would be affected by the options.
/// The options code path is validated for all assertions as part of the
...
)
{
    ...
    switch kind
    {
        case .assert:
            ...
            body1 =
            {
                #XCTKAssert(a && b, options: options1)
            }
            
            body2 =
            {
                #XCTKAssert(a && b, options: options2)
            }
        ...
        case .true:
            ...
            body1 =
            {
                #XCTKAssertTrue(a && b, options: options1)
            }
            
            body2 =
            {
                #XCTKAssertTrue(a && b, options: options2)
            }
        ...
        case .false:
            ...
            body1 =
            {
                #XCTKAssertFalse(a || b, options: options1)
            }
            
            body2 = 
            {
                #XCTKAssertFalse(a || b, options: options2)
            }
