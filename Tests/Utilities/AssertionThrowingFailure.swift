    ...
    let message: String? = captureFailureMessage
    {
        switch kind
        {
            ...
            case .equal:
                ...
                XCTKAssertEqual(try expr(), 1)
                
            case .notEqual:
                
                XCTKAssertNotEqual(try expr(), 1)
                
            case .equalWithAccuracy:
                
                XCTKAssertEqual(try expr(), 1, accuracy: 1)
                
            case .notEqualWithAccuracy:
                
                XCTKAssertNotEqual(try expr(), 1, accuracy: 1)
                
            case .identical:
                
                let object = TestError() as AnyObject
                
                XCTKAssertIdentical(try { throw TestError() }(), object)
                
            case .notIdentical:
                
                let object = TestError() as AnyObject
                
                XCTKAssertNotIdentical(try { throw TestError() }(), object)
                
            case .greaterThan:
                
                XCTKAssertGreaterThan(try expr(), 1)
                
            case .greaterThanOrEqual:
                
                XCTKAssertGreaterThanOrEqual(try expr(), 1)
                
            case .lessThan:
                
                XCTKAssertLessThan(try expr(), 1)
                
            case .lessThanOrEqual:
                
                XCTKAssertLessThanOrEqual(try expr(), 1)
