...
extension DiffNode
{
    ...
    internal static func makeRoot<T>(
        typeName    : String,
        expected    : T,
        actual      : T,
        tree        : [DiffNode]
    ...
    internal static func makeLeaf<T>(
        label       : DiffNodeLabel,
        expected    : T,
        actual      : T
    ) -> DiffNode where T : Equatable
    ...
    internal static func makeStructural<T>(
        label       : DiffNodeLabel,
        expected    : T,
        actual      : T,
        tree        : [DiffNode]
    ...
    ///   - tree: The diff nodes.
    /// - Returns: The different structural node.
    internal static func makeStructuralAny(
        label       : DiffNodeLabel,
        expected    : Any,
        actual      : Any,
        tree        : [DiffNode]
    ...
    internal static func makeCycle<T>(
        label       : DiffNodeLabel,
        expected    : T,
        actual      : T,
    ...
    internal static func makeMissing<T>(
        label       : DiffNodeLabel,
        expected    : T
    ) -> DiffNode where T : Equatable
    {
    ...
    internal static func makeUnexpected<T>(
        label   : DiffNodeLabel,
        actual  : T
    ) -> DiffNode where T : Equatable
    {
