...
must be true, and SwiftTestKit generates random inputs automatically, searching 
for a case that invalidates the property.

When a failing input is found, SwiftTestKit shrinks it to the smallest value 
